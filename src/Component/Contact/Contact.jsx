            ...
            <section className="py-6">
                <div className="rounded-xl bg-slate-50" style={{ backgroundImage: `url(${bgg})` }}>
                    <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-900">
                        <h1 className="text-5xl font-bold leading-none sm:text-7xl xl:max-w-3xl text-white">Contact</h1>
                        <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl text-white">Connect with us for book recommendations, collaborations, technical support, and more. We welcome your feedback and inquiries. Reach out and lets start a conversation</p>
            ...
            <section className="py-20 mb-8 rounded-2xl dark:bg-gray-100 dark:text-gray-900">
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    <div className="py-6 md:py-0 md:px-6">
                        ...
                        <div className="space-y-4">
                            <p className="flex items-center">
                                ...
                                <span>Hathazari,Chittaagong</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                                </svg>
                                <span>+880-1632216145</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                    ...
                    <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-[#23BE0A] dark:text-gray-50 focus:dark:ring-[#23BE0A] hover:dark:ring-[#23BE0A]">Submit</button>
                    </form>
                </div>
            </section>
        </div>
